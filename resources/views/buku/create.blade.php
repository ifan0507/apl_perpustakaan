                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="mb-3">
                                            <label for="thn_terbit" class="col-form-label "">Tahun Terbit <span
                                                    class="required" style="color:red">*</span></label>
                                            <select name="thn_terbit" id="thn_terbit"
                                                class="form-control select2  @error('thn_terbit') is-invalid @enderror">
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="mb-3">
                                            <label for="jml_halaman" class="col-form-label">Jumlah Halaman<span
                                                    class="required" style="color:red">*</span></label>
                                            <input type="number"
                                        ...
                                        <div class="mb-3">
                                            <label for="jml_halaman" class="col-form-label">Bahasa Buku<span
                                                    class="required" style="color:red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="jml_halaman" class="col-form-label">Kategori Buku<span
                                                    class="required" style="color:red">*</span></label>
                                        ...
                                        <div class="mb-3">
                                            <label for="jml_halaman" class="col-form-label">Jenis Buku<span
                                                    class="required" style="color:red">*</span></label>
